...
export function HeroComponent() {
  ...
  return (
    <div className="relative h-[700px] md:h-[800px] flex flex-col justify-center items-center p-6 text-black font-sans">
      <Image
        src="/images/hero/hero-color-background-w.webp"
        alt="Background"
        fill
